package com.taobao.yugong.extractor.postgresql;
...
public class PostgreSQLFullRecordExtractor extends AbstractRecordExtractor {
	
	private final YuGongContext context;
	@Setter
	private String              extractSql;
	
	public PostgreSQLFullRecordExtractor(YuGongContext context){
