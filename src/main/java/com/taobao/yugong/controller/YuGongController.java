...
import com.taobao.yugong.extractor.postgresql.PostgreSQLFullRecordExtractor;
        ...
        if (runMode == RunMode.FULL || runMode == RunMode.CHECK) {
            ...
            if (forceFull
                ...
                if (sourceDbType == DbType.ORACLE) {
                    ...
                    PostgreSQLFullRecordExtractor recordExtractor = new PostgreSQLFullRecordExtractor(context);
                    recordExtractor.setExtractSql(extractSql);
                    recordExtractor.setTracer(progressTracer);
                    return recordExtractor;
                } else {
